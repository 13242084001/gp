...
for day in day_list[-1:]:
    ...
    if 1:
        url = "http://17.push2.eastmoney.com/api/qt/clist/get?cb=jQuery11240964651097763543_1684395945560&pn=1&pz=765&po=1&np=1&ut=bd1d9ddb04089700cf9c27f6f7426281&fltt=2&invt=2&wbp2u=|0|0|0|web&fid=f3&fs=b:MK0021,b:MK0022,b:MK0023,b:MK0024&fields=f1,f2,f3,f4,f5,f6,f7,f8,f9,f10,f12,f13,f14,f15,f16,f17,f18,f20,f21,f23,f24,f25,f22,f11,f62,f128,f136,f115,f152&_=1684395945567"
        res = requests.get(url=url)
        ...
        for i in  data:
            ...
            if "-" != i.get("f6"):
                ...
                code = 'SZ' + i.get("f12") if "1" == i.get("f12")[:1] else 'SH' + i.get("f12")
                name = i.get("f14")
                zhang_fu = i.get("f3")
                huan_shou = i.get("f8")
                ...
                """
                if 1:#0.3 < zhang_fu and dang_qian_jia > kai_pan_jia and shang_ying_xian < 0.05 and huan_shou < 10 and liang_bi > 1:
                    ...
                    if day_df is not None:
                        ...
                        for x in ma_data_list:
                            if (max_ma * 0.975) <= x:
                                len_list.append(x)
                        if dang_qian_jia > max_ma and dang_qian_jia >= week_max_ma:
                            print(name)
                        ...
                        if dang_qian_jia > max_ma and ya_li > 0.2 and ya_li_1 < 0.2 and dang_qian_jia >= week_max_ma and ma5_distance < 1 and day_mavol5 >= day_mavol10 and round(ma5, 7) >= round(ma10, 7) and len(len_list) >=(len(ma_data_list) -3) and min(atan5, atan10, atan20) > 5 and atan_len >=3:# and today_liang > liang_max_5days and fang_liang >= 1.2:
                            print(name)
